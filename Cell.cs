...
namespace DFSAlgorithmMaze
{
	...
	public class Cell
	{
		...
		public void Draw(Graphics g)
		{
			...
			{
				// top wall
				g.DrawLine(Pens.DarkBlue, Row*kCellSize + kPadding, Column*kCellSize + kPadding, (Row+1) * kCellSize   + kPadding, Column*kCellSize +   kPadding);
			}
			if (Walls[1] == 1)
			{
				// left wall
				g.DrawLine(Pens.DarkBlue, Row*kCellSize  + kPadding, Column*kCellSize + kPadding, Row*kCellSize + kPadding, (Column+1)*kCellSize + kPadding);
			}
			if (Walls[2] == 1)
			{
				// bottom wall
				g.DrawLine(Pens.DarkBlue, Row*kCellSize + kPadding, (Column+1)*kCellSize + kPadding, (Row+1)*kCellSize + kPadding, (Column+1)*kCellSize + kPadding);
			}
			if (Walls[3] == 1)
			{
				// right wall
				g.DrawLine(Pens.DarkBlue, (Row+1)*kCellSize + kPadding , Column*kCellSize + kPadding, (Row+1)*kCellSize + kPadding, (Column+1)*kCellSize + kPadding);
			}
